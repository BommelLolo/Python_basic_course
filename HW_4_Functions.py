...
print(f"The largest of 1st and 2nd numbers is {largest_of_two_numbers(number_first, number_second)}")
print("-" * 20 + "FUNCTION 2" + "-"*20)
print(f"The smallest of three numbers is {smallest_of_three_numbers(number_first, number_second, number_third)}")
print("-" * 20 + "FUNCTION 3" + "-"*20)
print(f"The absolute value of first number is {abs_of_number(number_first)}")
